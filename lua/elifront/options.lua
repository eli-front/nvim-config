...
local options = elifront.user_opts("options", {
  opt = {
  ...
  g = {
    ...
    -- elifront specific global options
    ...
    ui_notifications_enabled = true,                                   -- disable notifications (TODO: rename to  notifications_enabled in elifront v4)
