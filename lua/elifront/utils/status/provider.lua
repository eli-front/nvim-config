--- ### elifront Status Providers
--
-- Statusline related provider functions for building statusline components
--
-- This module can be loaded with `local provider = require "elifront.utils.status.provider"`
--
-- @module elifront.utils.status.provider
-- @copyright 2023
-- @license GNU General Public License v3.0

local M = {}

local condition = require("elifront.utils.status.condition")
local env = require("elifront.utils.status.env")
local status_utils = require("elifront.utils.status.utils")
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.fill }
function M.fill()
  return "%="
end
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.signcolumn }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.numbercolumn }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.foldcolumn }
-- @see elifront.utils.status.utils.stylize
function M.foldcolumn(opts)
  opts = extend_tbl({ escape = false }, opts)
  local ffi = require("elifront.utils.ffi") -- get elifront C extensions
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.tabnr() }
function M.tabnr()
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.spell() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.paste() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.macro_recording() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.showcmd() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.search_count() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.mode_text() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.percentage() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.ruler({ pad_ruler = { line = 3, char = 2 } }) }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.scrollbar() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.close_button() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.filetype() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.filename() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.file_encoding() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.file_format() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.unique_path() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.file_modified() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.file_read_only() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.file_icon() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.git_branch() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.git_diff({ type = "added" }) }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.diagnostics({ severity = "ERROR" }) }
-- @see elifront.utils.status.utils.stylize
function M.diagnostics(opts)
  ...
  return function(self)
    local bufnr = self and self.bufnr or 0
    local count =
        #vim.diagnostic.get(bufnr, opts.severity and { severity = vim.diagnostic.severity[opts.severity] })
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.lsp_progress() }
-- @see elifront.utils.status.utils.stylize
function M.lsp_progress(opts)
  local spinner = utils.get_spinner("LSPLoading", 1) or { "" }
  return function()
    local _, Lsp = next(elifront.lsp.progress)
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.lsp_client_names({ expand_null_ls = true, truncate = 0.25 }) }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.treesitter_status() }
-- @see elifront.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("elifront.utils.status").provider.str({ str = "Hello" }) }
-- @see elifront.utils.status.utils.stylize
function M.str(opts)
