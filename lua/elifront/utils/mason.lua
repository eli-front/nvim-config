...
--
-- This module can be loaded with `local mason_utils = require("elifront.utils.mason")`
--
-- @module elifront.utils.mason
-- @see elifront.utils
-- @copyright 2022
...
local function mason_notify(msg, type)
  utils.notify(msg, type, { title = "Mason" })
end
            ...
            pkg:check_new_version(function(update_available, version)
              if update_available then
                ...
                pkg:install():on("closed", function()
                  mason_notify(("Updated %s"):format(pkg.name))
                end)
              else
